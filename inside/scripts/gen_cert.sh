...
gen_cert()
{
    ...
    echo "[$(date)]" [$1] Submit RAS certificate to DigiCert ct log server......
    ct-submit ct1.digicert-ct.com/log/ < /data/cert/$1/ras/cert.pem > /data/cert/$1/ras/sct/digicert_ct1.sct
  ...
  /root/.acme.sh/acme.sh \
    ...
    echo "[$(date)]" [$1] Submit ECC certificate to DigiCert ct log server......
    ct-submit ct1.digicert-ct.com/log/ < /data/cert/$1/ecc/cert.pem > /data/cert/$1/ecc/sct/comodo_sabre.sct
